        ...
        <div class="row">
            ...
            try{
                ...
                if($resultado->rowCount() > 0){
                    ?>
            <table summary="Busca de Cursos - tabela estruturada em: nome do curso, nota do curso,
área do curso e seu campus" class="table">
                <caption>Total de Cursos Cadastrados</caption>
                <thead>
                    <tr>
                        <th scope="col">ID</th>
